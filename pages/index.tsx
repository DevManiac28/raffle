...
import { Container, SimpleGrid, Flex, Stack, Text, Box, Button, Input } from '@chakra-ui/react';
import { MediaRenderer, Web3Button, useAddress, useConnect, useContract, useContractRead } from "@thirdweb-dev/react";
        ...
        <Flex justifyContent={"center"} alignItems={"center"} p={"5%"}>
          <Stack spacing={"10"}>
            ...
            {!isLoadingTotalEntries && (
              <Text>Total Entires: {totalEntries.toString()} Entries</Text>
            )}
          </Stack>
        </Flex>
      </SimpleGrid>
